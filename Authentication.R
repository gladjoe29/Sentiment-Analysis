install.packages("twitteR", lib="J:/Final Project/Sentinalysis/")
install.packages("ROAuth", lib="J:/Final Project/Sentinalysis/")
install.packages("rtweet", lib="J:/Final Project/Sentinalysis/")
install.packages("sentimentr", lib="J:/Final Project/Sentinalysis/")
install.packages("tm", lib="J:/Final Project/Sentinalysis/")
install.packages("SnowballC", lib="J:/Final Project/Sentinalysis/")
install.packages("wordcloud", lib="J:/Final Project/Sentinalysis/")
install.packages("RColorBrewer", lib="J:/Final Project/Sentinalysis/")
install.packages("syuzhet", lib="J:/Final Project/Sentinalysis/")
install.packages("ggplot2", lib="J:/Final Project/Sentinalysis/")
install.packages("plyr", lib="J:/Final Project/Sentinalysis/")
library(twitteR, lib="J:/Final Project/Sentinalysis/")
library(rtweet, lib="J:/Final Project/Sentinalysis/")
library(ROAuth, lib="J:/Final Project/Sentinalysis/")
library(sentimentr, lib="J:/Final Project/Sentinalysis/")
library(tm, lib="J:/Final Project/Sentinalysis/")
library(plyr, lib="J:/Final Project/Sentinalysis/")
library(SnowballC, lib="J:/Final Project/Sentinalysis/")
library(wordcloud, lib="J:/Final Project/Sentinalysis/")
library(RColorBrewer, lib="J:/Final Project/Sentinalysis/")
library(syuzhet, lib="J:/Final Project/Sentinalysis/")
library(ggplot2, lib="J:/Final Project/Sentinalysis/")
